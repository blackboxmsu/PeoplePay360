...
export const SEED_ATTENDANCE = [
  { id: 'att-1', employeeId: 'emp-1', employeeName: 'Aarav Mehta', date: '2026-09-02', checkIn: '09:05', checkOut: '18:10', workedHours: 9.08, status: 'Present', department: 'Finance', overtime: '0.50 hrs', notes: 'Biometric punch recorded.' },
  { id: 'att-2', employeeId: 'emp-2', employeeName: 'Sara Khan', date: '2026-09-02', checkIn: '09:15', checkOut: '18:02', workedHours: 8.78, status: 'Present', department: 'HR', overtime: '0.00 hrs', notes: 'Standard shift.' },
  { id: 'att-3', employeeId: 'emp-3', employeeName: 'John Dsouza', date: '2026-09-02', checkIn: '09:32', checkOut: '17:58', workedHours: 8.43, status: 'Present', department: 'Engineering', overtime: '0.00 hrs', notes: 'Engineering flexible punch.' },
  { id: 'att-4', employeeId: 'emp-4', employeeName: 'Neha Patel', date: '2026-09-02', checkIn: '—', checkOut: '—', workedHours: 0.00, status: 'Absent', department: 'HR', overtime: '0.00 hrs', notes: 'Unplanned absence.' },
  { id: 'att-5', employeeId: 'emp-5', employeeName: 'Rohan Patel', date: '2026-09-03', checkIn: '09:02', checkOut: '18:00', workedHours: 8.97, status: 'Present', department: 'Engineering', overtime: '0.00 hrs', notes: 'Self-service web punch.' },
  { id: 'att-6', employeeId: 'emp-5', employeeName: 'Rohan Patel', date: '2026-09-02', checkIn: '08:58', checkOut: '18:15', workedHours: 9.28, status: 'Present', department: 'Engineering', overtime: '0.25 hrs', notes: 'Sprint deployment.' }
];
